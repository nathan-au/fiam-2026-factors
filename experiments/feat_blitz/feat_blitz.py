...
Research origin: docs/REDDIT_RESEARCH.md sec 2.2 (Blitz, Hanauer, Honarvar, Huisman, van Vliet, FAJ 2023: five short-horizon signals in MSCI World constituents only, composite alpha > 12%, uncorrelated with FF factors; the project's composite deliberately has no short-term content).
