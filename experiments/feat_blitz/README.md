...
## Research origin
docs/RESEARCH.md Part II sec 2.2 (Blitz et al., *FAJ* 2023: MSCI World constituents only, individual gross returns 5-8%/yr, composite > 12% six-factor alpha, break-even cost > 30bp, alpha persists post-publication; grade: demonstrated, not on our sample).
