...
Run:  .venv/bin/python experiments/train_weighting/train_weighting.py [--models et,lgbm] [--seed 42] [--smoke]
...
HERE = Path(__file__).resolve().parent  # experiments/train_weighting/
OUTPUT = HERE / "output"
...
ARMS = {
    ...
    "w_mcap": {"weight": "mcap"},
    "w_sqrt_dolvol": {"weight": "sqrt_dolvol"},
    "all_unweighted": {"train": "all"},
    "all_w_sqrt_mcap": {"train": "all", "weight": "sqrt_mcap"},
    "all_w_mcap": {"train": "all", "weight": "mcap"},
}
