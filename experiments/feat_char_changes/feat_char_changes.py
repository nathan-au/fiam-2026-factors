...
Research origin: docs/NEW.md sec 3.3 item 5 (returns are driven by CHANGES in characteristics; 'momentum in firm attributes should be more investigated', arXiv 2203.07865).
