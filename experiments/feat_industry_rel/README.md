...
## Research origin
docs/RESEARCH.md Part I sec 3.3 items 3-4 (residual / industry-neutral / 52-week-high-neutral momentum; "adjusting for sector boosts [the better result] from 20% to 78% of the time", largest for value-weighted large-cap strategies; grade C).
