...
## Research origin
docs/NEW.md sec 3.7 (insider composite of role, size, clustering gives >= 1%/mo alpha equal-weighted, "works best for mid/large caps", alpha compressed since pre-2010; SEC EDGAR, free, filed within 2 business days).
