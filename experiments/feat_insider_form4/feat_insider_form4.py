...
Research origin: docs/NEW.md sec 3.7 (insider composite of role, size, clustering gives >= 1%/mo alpha equal-weighted, 'works best for mid/large caps', alpha compressed since pre-2010; SEC EDGAR free, ~2-business-day filing lag).
...
EXTERNAL DATA (Round D of docs/NEW.md sec 4; FIAM sec 4 permits external data joined on a dated identifier): SEC DERA Insider Transactions Data Sets 2020q1 onward, cache/sec_form345/ (generic user agent), issuer CIK mapped to permno through the 8-K file.
