...
Research origin: docs/NEW.md sec 3.7 (short interest: surprise in short interest negatively predicts the cross-section; 'more valuable as a short-selection / squeeze-risk filter given our Jan-2021 loss').
...
EXTERNAL DATA (Round D of docs/NEW.md sec 4; FIAM sec 4 permits external data joined on a dated identifier): FINRA bi-monthly short interest (mid-month settlement file per characteristic month), cache/finra_short_interest/; symbols matched through the panel ticker.
