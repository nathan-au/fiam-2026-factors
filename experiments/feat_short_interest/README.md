...
## Research origin
docs/NEW.md sec 3.7 (FINRA short interest: surprise in short interest negatively predicts the cross-section; "more valuable as a short-selection / squeeze-risk filter given our Jan-2021 loss"; free data; published ~1 week after settlement).
