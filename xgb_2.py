...
Follows xgb.py (docs/XGB.md) without touching it. That run early-stopped on validation MSE (the 2025 fold
...
Run:  .venv/bin/python xgb_2.py [--arms modern_nomom,modern,all_nomom,modern_nomom_trad] [--suffix _x] [--raw-target] [--smoke]
...
# docs/XGB.md's run early-stopped on validation MSE (2025 fold stopped after 4 trees) with a 6-config
