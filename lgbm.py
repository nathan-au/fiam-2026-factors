...
docs/NEXT.md sec 1 recommended LightGBM; docs/XGB.md showed default-style boosting overfits this panel.
...
Run:  .venv/bin/python lgbm.py [--arms modern_nomom,modern,all_nomom,modern_nomom_trad] [--suffix _x] [--raw-target] [--smoke]
